...
def select_pdf_and_classify(file):
    ...
    #cur.execute("INSERT INTO bl (nro_bl, puerto_de_carga, puerto_de_descarga, vessel, peso, no_voyage) VALUES ('numero_prueba_bl3','Peru','20kg','el callao', 'g','g');")
    #conn.commit()
...
def recognize_pdf():
    try:
        ...
        return jsonify({'type': result_label})
    except Exception as e:
